...
# Carregar el dataset original
file_path = 'training.1600000.processed.noemoticon.csv'

# Només carregar la columna 0 (Ranking) i la columna 5 (Tweet)
columns = ['Ranking', 'Tweet']
data = pd.read_csv(file_path, usecols=[0, 5], header=None, names=columns, encoding='latin1')
