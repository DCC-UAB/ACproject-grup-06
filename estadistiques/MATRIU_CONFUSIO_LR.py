# -*- coding: utf-8 -*-
"""
Created on Fri Dec 20 10:23:42 2024
...
def executar_grid_search(X_train_tfidf, y_train):
    print("Executant Grid Search per Regressió Logística...")
    param_grid = {
...
def main():
    ...
    plt.title('Matriu de Confusió - Regressió Logística (Grid Search)')
    plt.xlabel('Prediccions')
    plt.ylabel('Valors Reals')
    plt.savefig(os.path.join(output_dir, 'matriu_confusio_logistic_regression_grid_search.png'))
    plt.show()
